...
public class SolidityCompiler {
    ...
    public Result compileSrc(File source, boolean optimize, boolean combinedJson, Options... options) throws IOException {
        ...
        if(source.getParentFile() != null) commandParts.add(source.getParentFile().getAbsolutePath());
        if(source.getParentFile().getParentFile() != null) commandParts.add(source.getParentFile().getParentFile().getAbsolutePath());
        if (optimize) {
